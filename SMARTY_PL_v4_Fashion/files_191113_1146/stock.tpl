	...
	<html lang="{{/literal}}{{$xml->getItemEscape("/shop/currency/@country")}}{{literal}}" >{{/literal}}
		...
		<head>{{$txt['107421::10001_006m']|escape:'iai'}}
			...
			{{if !( $xml->getItem("/shop/page/@type")  == (string) 'main')}}
				...
				{{/if}}
			{{/if}}
			<script type="text/javascript" src="/gfx/{{$xml->getItemEscape("language/@id")}}/stock_info.js.gzip?r=1573641886">			</script>
            ...
            var google_api_key = '{{$xml->getItemEscape("/shop/page/stock/google_api_key/@value")}}';
						...
						<div class="stock_info_outline" id="stock_info_58110">
							<div class="big_label stock_label">
								<span class="stock_label">{{$txt['107884::stock_info_label']}}</span>
							</div>
								...
								<div class="stock_info_details">
									{{if  $xml->getItem("page/stock/@name") and ( $xml->getItem("page/stock/@name")  neq (string) '')}}
										<div class="stock_info_section" id="stock_info_details_name">
											<span class="stock_info_title">{{$txt['107884::stock_info_name_title']}}</span>
									...
									{{if  $xml->getItem("page/stock/@street") and ( $xml->getItem("page/stock/@street")  neq (string) '')}}
										<div class="stock_info_section" id="stock_info_details_street">
											<span class="stock_info_title">{{$txt['107884::stock_info_street_title']}}</span>
									...
									{{if  $xml->getItem("page/stock/@zipcode") and ( $xml->getItem("page/stock/@zipcode")  neq (string) '')}}
										<div class="stock_info_section" id="stock_info_details_zipcode">
											<span class="stock_info_title">{{$txt['107884::stock_info_zipcode_title']}}</span>
									...
									{{if  $xml->getItem("page/stock/@city") and ( $xml->getItem("page/stock/@city")  neq (string) '')}}
										<div class="stock_info_section" id="stock_info_details_city">
											<span class="stock_info_title">{{$txt['107884::stock_info_city_title']}}</span>
									...
									{{if  $xml->getItem("page/stock/@country") and ( $xml->getItem("page/stock/@country")  neq (string) '')}}
										<div class="stock_info_section" id="stock_info_details_country">
											<span class="stock_info_title">{{$txt['107884::stock_info_country_title']}}</span>
									...
									{{if  $xml->getItem("page/stock/@phone") and ( $xml->getItem("page/stock/@phone")  neq (string) '')}}
										<div class="stock_info_section" id="stock_info_details_phone">
											<span class="stock_info_title">{{$txt['107884::stock_info_phone_title']}}</span>
									...
									{{if  $xml->getItem("page/stock/@fax") and ( $xml->getItem("page/stock/@fax")  neq (string) '')}}
										<div class="stock_info_section" id="stock_info_details_fax">
											<span class="stock_info_title">{{$txt['107884::stock_info_fax_title']}}</span>
									...
									{{if  $xml->getItem("page/stock/@mail") and ( $xml->getItem("page/stock/@mail")  neq (string) '')}}
										<div class="stock_info_section" id="stock_info_details_mail">
											<span class="stock_info_title">{{$txt['107884::stock_info_mail_title']}}</span>
											<a {{assign "hrefAttributeTmp6" ""}}  class="stock_info_value" title="{{$xml->getItemEscape("page/stock/@mail")}}" {{if $xml->getItem("page/stock/@mail_link") and $xml->getItem("page/stock/@mail_link") neq (string) ''}}{{capture name="hrefAttributeTmp6" assign="hrefAttributeTmp6"}}{{$xml->getItemEscape("page/stock/@mail_link")}}{{/capture}}{{else}}{{capture name="hrefAttributeTmp6" assign="hrefAttributeTmp6"}}mailto:{{$xml->getItemEscape("page/stock/@mail")}}{{/capture}}{{/if}}  href="{{$hrefAttributeTmp6}}">{{$xml->getItemEscape("page/stock/@mail")}}</a>
										</div>
									{{/if}}
									{{if  $xml->getItem("page/stock/@gg") and ( $xml->getItem("page/stock/@gg")  neq (string) '')}}
										<div class="stock_info_section" id="stock_info_details_gg">
											<span class="stock_info_title">{{$txt['107884::stock_info_gg_title']}}</span>
									...
									{{if  $xml->getItem("page/stock/@skype") and ( $xml->getItem("page/stock/@skype")  neq (string) '')}}
										<div class="stock_info_section" id="stock_info_details_skype">
											<span class="stock_info_title">{{$txt['107884::stock_info_skype_title']}}</span>
									...
									{{if  $xml->getItem("page/stock/@street") and ( $xml->getItem("page/stock/@street")  neq (string) '') or  $xml->getItem("page/stock/@zipcode") or ( $xml->getItem("page/stock/@zipcode")  neq (string) '') or  $xml->getItem("page/stock/@city") and ( $xml->getItem("page/stock/@city")  neq (string) '')}}
										{{if ($mapHide  neq (string) '') and  $xml->getItem("page/stock/google_api_key/@value")}}
											<a {{assign "classAttributeTmp4" ""}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}show_on_map{{/capture}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}btn-small show_on_map{{/capture}} href="http://maps.google.com/maps?q={{$xml->getItemEscape("page/stock/@zipcode")}}%20{{$xml->getItemEscape("page/stock/@city")}}%20{{$xml->getItemEscape("page/stock/@street")}}"  class="{{$classAttributeTmp4}}">{{$txt['107884::stock_map']}}</a>
										{{/if}}
									{{/if}}
								</div>
								<div class="stock_info_hours">
									<span class="stock_info_hours_label">{{$txt['107884::stock_info_hours_label']}}</span>
									{{if  $xml->getItem("page/stock_time/monday")}}
										<div class="stock_info_hours_day">
											<span class="stock_info_hours_day">{{$txt['107884::stock_info_hours_monday']}}</span>
											<span class="stock_info_hours_time">
												{{if  $xml->getItem("page/stock_time/monday/@open")  neq (string)  $xml->getItem("page/stock_time/monday/@close")}}
													{{$txt['107884::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/monday/@open")}}{{$txt['107884::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/monday/@close")}}
												{{else}}
													{{$txt['107884::stock_info_hours_inactive']}}
												{{/if}}
												</span>
										</div>
									{{/if}}
									{{if  $xml->getItem("page/stock_time/tuesday")}}
										<div class="stock_info_hours_day">
											<span class="stock_info_hours_day">{{$txt['107884::stock_info_hours_tuesday']}}</span>
											<span class="stock_info_hours_time">
												{{if  $xml->getItem("page/stock_time/tuesday/@open")  neq (string)  $xml->getItem("page/stock_time/tuesday/@close")}}
													{{$txt['107884::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/tuesday/@open")}}{{$txt['107884::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/tuesday/@close")}}
												{{else}}
													{{$txt['107884::stock_info_hours_inactive']}}
												{{/if}}
												</span>
									...
									{{if  $xml->getItem("page/stock_time/wednesday")}}
										<div class="stock_info_hours_day">
											<span class="stock_info_hours_day">{{$txt['107884::stock_info_hours_wednesday']}}</span>
											<span class="stock_info_hours_time">
												{{if  $xml->getItem("page/stock_time/wednesday/@open")  neq (string)  $xml->getItem("page/stock_time/wednesday/@close")}}
													{{$txt['107884::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/wednesday/@open")}}{{$txt['107884::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/wednesday/@close")}}
												{{else}}
													{{$txt['107884::stock_info_hours_inactive']}}
												{{/if}}
												</span>
									...
									{{if  $xml->getItem("page/stock_time/thursday")}}
										<div class="stock_info_hours_day">
											<span class="stock_info_hours_day">{{$txt['107884::stock_info_hours_thursday']}}</span>
											<span class="stock_info_hours_time">
												{{if  $xml->getItem("page/stock_time/thursday/@open")  neq (string)  $xml->getItem("page/stock_time/thursday/@close")}}
													{{$txt['107884::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/thursday/@open")}}{{$txt['107884::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/thursday/@close")}}
												{{else}}
													{{$txt['107884::stock_info_hours_inactive']}}
												{{/if}}
												</span>
									...
									{{if  $xml->getItem("page/stock_time/friday")}}
										<div class="stock_info_hours_day">
											<span class="stock_info_hours_day">{{$txt['107884::stock_info_hours_friday']}}</span>
											<span class="stock_info_hours_time">
												{{if  $xml->getItem("page/stock_time/friday/@open")  neq (string)  $xml->getItem("page/stock_time/friday/@close")}}
													{{$txt['107884::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/friday/@open")}}{{$txt['107884::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/friday/@close")}}
												{{else}}
													{{$txt['107884::stock_info_hours_inactive']}}
												{{/if}}
												</span>
									...
									{{if  $xml->getItem("page/stock_time/saturday")}}
										<div class="stock_info_hours_day">
											<span class="stock_info_hours_day">{{$txt['107884::stock_info_hours_saturday']}}</span>
											<span class="stock_info_hours_time">
												{{if  $xml->getItem("page/stock_time/saturday/@open")  neq (string)  $xml->getItem("page/stock_time/saturday/@close")}}
													{{$txt['107884::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/saturday/@open")}}{{$txt['107884::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/saturday/@close")}}
												{{else}}
													{{$txt['107884::stock_info_hours_inactive']}}
												{{/if}}
												</span>
									...
									{{if  $xml->getItem("page/stock_time/sunday")}}
										<div class="stock_info_hours_day">
											<span class="stock_info_hours_day">{{$txt['107884::stock_info_hours_sunday']}}</span>
											<span class="stock_info_hours_time">
												{{if  $xml->getItem("page/stock_time/sunday/@open")  neq (string)  $xml->getItem("page/stock_time/sunday/@close")}}
													{{$txt['107884::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/sunday/@open")}}{{$txt['107884::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/sunday/@close")}}
												{{else}}
													{{$txt['107884::stock_info_hours_inactive']}}
												{{/if}}
												</span>
							...
							{{if  $xml->getItem("page/stock/google_api_key/@value") and ( $xml->getItem("page/stock/@street") and ( $xml->getItem("page/stock/@street")  neq (string) '') or  $xml->getItem("page/stock/@zipcode") and ( $xml->getItem("page/stock/@zipcode")  neq (string) '') or  $xml->getItem("page/stock/@city") and ( $xml->getItem("page/stock/@city")  neq (string) ''))}}
								<div {{assign "classAttributeTmp5" ""}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}stock_map_all{{/capture}}{{if ($mapHide neq (string) '')}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}stock_map_all hide{{/capture}}{{/if}}  class="{{$classAttributeTmp5}}">
									<div class="loadingMap">
										<div class="loadingContent">
											<div class="loadingBox">
												<span class="loadingMap">{{$txt['107884::64553_013']}}</span>
												<span class="loadingNav">{{$txt['107884::64553_014']}}</span>
												<span class="loadingAddress">{{$txt['107884::64553_015']}}</span>
							...
							{{if  $xml->getItem("page/stock/text()")}}
								<div class="big_label stock_label">
									<span class="stock_label">{{$txt['107884::stock_info_label2']}}</span>
								</div>
