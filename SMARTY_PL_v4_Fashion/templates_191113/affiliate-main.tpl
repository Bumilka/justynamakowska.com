				...
				{{if !( $xml->getItem("action/set_render/item")) or ( $xml->getItem("action/set_render/item/@name")  == (string) 'content')}}
					<div {{assign "classAttributeTmp2" ""}}  id="content"{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}span9{{/capture}}{{if $xml->getItem("page/@type") == (string) 'projector'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['107419::70925_projector_c_class']}}{{/capture}}{{elseif $xml->getItem("page/@type") == (string) 'search'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['107419::70925_search_c_class']}}{{/capture}}{{elseif $xml->getItem("page/@type") == (string) 'main'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['107419::70925_main_c_class']}}{{/capture}}{{elseif $xml->getItem("page/@type") == (string) 'navigation'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['107419::70925_navigation_page_c_class']}}{{/capture}}{{elseif $xml->getItem("page/@type") == (string) 'blog-list'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['107419::70925_blog_list_c_class']}}{{/capture}}{{elseif $xml->getItem("page/@type") == (string) 'blog-item'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['107419::70925_blog_item_c_class']}}{{/capture}}{{else}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['107419::70925_otherwise_c_class']}}{{/capture}}{{/if}}  class="{{$classAttributeTmp2}}">
						...
						<div class="affiliate_main_cms_label">
							<span class="big_label affiliate_main_cms_label">{{$txt['107749::affiliate_main_cms_label']}}</span>
						</div>
						{{if  $xml->getItem("page/text/body")}}
							<div class="affiliate_main_cms">
								<div class="affiliate_main_cms_sub cm">{{$xml->getItem("page/text/body")}}
								</div>
							</div>
						{{/if}}
						<div id="affiliate_main_menu" class="row">
							<div class="affiliate_stats col-md-6 col-sm-12" id="affiliate_stats">
								<div class="affiliate_stats_sub col-md-12">
									<h3>{{$txt['107749::40005_005']}}
									</h3>
									<div>
										<i class="{{$txt['107749::40005_005i']}}"></i>{{$txt['107749::40005_005stats']}}
									</div>
									<a {{assign "classAttributeTmp3" ""}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}btn-small{{/capture}} href="affiliate-stats.php" {{if $xml->getItem("page/@type") == (string) 'affiliate-stats'}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}activ{{/capture}}{{/if}} title="{{$txt['107749::59244_011']}}"  class="{{$classAttributeTmp3}}">{{$txt['107749::59244_012']}}</a>
									<a {{assign "classAttributeTmp4" ""}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}btn-small{{/capture}} href="affiliate-orders.php" {{if $xml->getItem("page/@type") == (string) 'affiliate-orders'}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}activ{{/capture}}{{/if}} title="{{$txt['107749::59244_013']}}"  class="{{$classAttributeTmp4}}">{{$txt['107749::59244_014']}}</a>
									<a {{assign "classAttributeTmp5" ""}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}btn-small{{/capture}} href="affiliate-clients.php" {{if $xml->getItem("page/@type") == (string) 'affiliate-clients'}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}activ{{/capture}}{{/if}} title="{{$txt['107749::59244_015']}}"  class="{{$classAttributeTmp5}}">{{$txt['107749::59244_016']}}</a>
								</div>
							</div>
							<div class="affiliate_generator col-md-6 col-sm-12" id="affiliate_generator">
								<div class="affiliate_generator_sub col-md-12">
									<h3>{{$txt['107749::40005_005gk']}}
									</h3>
									<div>
										<i class="{{$txt['107749::40005_005gki']}}"></i>{{$txt['107749::40005_005statsgk']}}
									</div>
									<a {{assign "classAttributeTmp6" ""}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}btn-small{{/capture}} href="affiliate-generator.php?generate=promoCodes" {{if $xml->getItem("page/generator[@type='promoCodes']")}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}activ{{/capture}}{{/if}} title="{{$txt['107749::59244_0119']}}"  class="{{$classAttributeTmp6}}">{{$txt['107749::59244_0129']}}</a>
									<a {{assign "classAttributeTmp7" ""}}{{capture name="classAttributeTmp7" assign="classAttributeTmp7"}}btn-small{{/capture}} href="affiliate-generator.php?generate=html" {{if $xml->getItem("page/generator[@type='html']")}}{{capture name="classAttributeTmp7" assign="classAttributeTmp7"}}activ{{/capture}}{{/if}} title="{{$txt['107749::59244_0112']}}"  class="{{$classAttributeTmp7}}">{{$txt['107749::59244_0122']}}</a>
									<a {{assign "classAttributeTmp8" ""}}{{capture name="classAttributeTmp8" assign="classAttributeTmp8"}}btn-small{{/capture}} href="affiliate-generator.php?generate=php" {{if $xml->getItem("page/generator[@type='php']")}}{{capture name="classAttributeTmp8" assign="classAttributeTmp8"}}activ{{/capture}}{{/if}} title="{{$txt['107749::59244_01551']}}"  class="{{$classAttributeTmp8}}">{{$txt['107749::59244_0165']}}</a>
									<a {{assign "classAttributeTmp9" ""}}{{capture name="classAttributeTmp9" assign="classAttributeTmp9"}}btn-small{{/capture}} href="affiliate-generator.php?generate=js" {{if $xml->getItem("page/generator[@type='js']")}}{{capture name="classAttributeTmp9" assign="classAttributeTmp9"}}activ{{/capture}}{{/if}} title="{{$txt['107749::59244_0133']}}"  class="{{$classAttributeTmp9}}">{{$txt['107749::59244_0143']}}</a>
								</div>
							</div>
							<div class="affiliate_calculations col-md-6 col-sm-12" id="affiliate_calculations">
								<div class="affiliate_calculations_sub col-md-12">
									<h3>{{$txt['107749::40005_005ac']}}
									</h3>
									<div>
										<i class="{{$txt['107749::40005_005aci']}}"></i>{{$txt['107749::40005_005statsac']}}
									</div>
									<a {{assign "classAttributeTmp10" ""}}{{capture name="classAttributeTmp10" assign="classAttributeTmp10"}}btn-small{{/capture}} href="affiliate-calculations.php" {{if $xml->getItem("page/@type") == (string) 'affiliate-calculations'}}{{capture name="classAttributeTmp10" assign="classAttributeTmp10"}}activ{{/capture}}{{/if}} title="{{$txt['107749::59244_005']}}"  class="{{$classAttributeTmp10}}">{{$txt['107749::59244_006']}}</a>
								</div>
							</div>
							<div class="affiliate_calculations col-md-6 col-sm-12" id="affiliate_calculations">
								<div class="affiliate_calculations_sub col-md-12">
									<h3>{{$txt['107749::40005_005sd']}}
									</h3>
									<div>
										<i class="{{$txt['107749::40005_005sdi']}}"></i>{{$txt['107749::40005_005statssd']}}
									</div>
									<a {{assign "classAttributeTmp11" ""}}{{capture name="classAttributeTmp11" assign="classAttributeTmp11"}}btn-small{{/capture}} href="affiliate-resources.php" {{if $xml->getItem("page/@type") == (string) 'affiliate-resources'}}{{capture name="classAttributeTmp11" assign="classAttributeTmp11"}}activ{{/capture}}{{/if}} title="{{$txt['107749::59244_009']}}"  class="{{$classAttributeTmp11}}">{{$txt['107749::59244_010']}}</a>
								</div>
							</div>
						</div>
					</div>
